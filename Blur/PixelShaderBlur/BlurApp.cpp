...
ID3D11PixelShader * BlurApp::GetPixelShader(std::string name)
{
...
void BlurApp::DrawScene()
{
	...
	// --- //
	auto pPSO = mPSOs[Screen].get();
	md3dImmediateContext->IASetInputLayout(pPSO->pIL);
	md3dImmediateContext->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST);
	auto geo = mRitemLayer[Screen][0]->Geo;
	auto pib = static_cast<ID3D11Buffer*>(geo->IndexBufferGPU.Get());
	md3dImmediateContext->IASetIndexBuffer(pib, geo->IndexFormat, 0);
	...
	mBlur.BlurInPlace(md3dImmediateContext, mOffscreenSRV.Get(), mOffscreenRTV.Get(), mDepthStencilView, 4);
...
void BlurApp::BuildOffScreenBuffer()
{
	...
	screenTex->Resource = mOffscreenSRV; 
